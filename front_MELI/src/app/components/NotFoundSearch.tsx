...
import styles from "../styles/notFoundSearch.module.css";
...
export const NotFoundSearch = ({ message, children }: Props) => {
  const NotFound = (
    <div className={styles["not-found-search"]}>
      <svg
  ...
  return (
    <ConditionalRender condition={!message} Else={NotFound}>
      {children}
    </ConditionalRender>
  );
};
